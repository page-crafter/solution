...
from page_crafter.api.routers.chat import (
...
from page_crafter.shared.schemas.chat import ChatStreamRequest
...
def test_chat_stream_events_emits_started_streaming_and_completed_stats(monkeypatch) -> None:
    ...
    monkeypatch.setattr("page_crafter.api.routers.chat.stream_lightrag_query", fake_stream)
