...
from page_crafter.worker.page_editor.generate_markdown import (
...
from page_crafter.worker.page_editor.proposals import (
...
def test_generation_uses_only_target_page_and_instruction(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "page_crafter.worker.page_editor.generate_markdown.build_update_graph",
        lambda: Graph(),
    )
...
def test_auto_model_config_uses_client_that_omits_model(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "page_crafter.worker.page_editor.generate_markdown.get_settings",
...
def test_auto_routed_openai_client_posts_without_model(monkeypatch) -> None:
    ...
    monkeypatch.setattr("page_crafter.worker.page_editor.generate_markdown.httpx.Client", Client)
