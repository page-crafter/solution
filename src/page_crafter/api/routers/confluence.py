...
from page_crafter.shared.schemas.confluence import (
    CreatePageRequest,
    MovePageRequest,
    PageDetail,
    PageRead,
...
def create_empty_page(
    ...
    enqueue_task_for_job(
        session,
        run,
        "page_crafter.create_empty_page",
        run.id,
        request.title,
        request.parent_id,
        actor=user.email,
