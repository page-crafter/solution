...
from page_crafter.api.queue_app import queue_app
from page_crafter.shared.jobs.history import record_task_queued
...
def enqueue_task(name: str, *args, celery_task_id: str | None = None, **kwargs) -> str:
    ...
    result = queue_app.send_task(name, args=args, kwargs=kwargs, task_id=celery_task_id)
...
def revoke_task(task_id: str) -> None:
    ...
    queue_app.control.revoke(task_id, terminate=True)
