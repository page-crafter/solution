...
from cm_api.services.queue import enqueue_task_for_job, revoke_task
...
def create_proposal(
    ...
    enqueue_task_for_job(
        session,
        proposal,
        "cm_worker.propose_markdown_update",
        proposal.id,
        actor=user.email,
